...
export default function Counter({
  ...
  return (
    <div className="flex flex-row items-stretch">
      <div
        className="rounded-l-full p-2 border-1 select-none hover:bg-zinc-200 cursor-pointer"
      ...
      <div
        className="rounded-r-full p-2 border-1 select-none hover:bg-zinc-200 cursor-pointer"
        onClick={() => handeChange(value + 1)}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
